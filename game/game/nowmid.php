...
\player\upplayerlv($sid,$dblj);//自动升级
        ...
        if ($cxallplayer[$i]['uname']!=""){
            ...
            if ($second > 300){
               ...
               if ($clubp){
                ...
                $playerhtml .="<a href='?cmd=$playercmd'>{$club->clubname}$cxuname</a><br/>";
            }
...
$nowhtml = <<<HTML
$clmid->mname$pvphtml<a href="?cmd=$mytask">任务($taskcount)</a><a href="?cmd=$gonowmid">刷新</a><br/>
$npchtml
$bosshtml
$gwhtml<br/>
---------------------------<br/>
...
<!--$clmid->playerinfo-->
---------------------------<br/>
【<a href="?cmd=$goliaotian" >世界聊天</a>】
<div id="ltmsg">
$lthtml
</div>
$clmid->midinfo<br/>
---------------------------<br/>
<a href="?cmd=$goliaotian" >聊天</a>|<a href="?cmd=$fangshi" >集市</a>|<a href="?cmd=$clubcmd" >门派</a>|<a href="?cmd=$cwcmd" >宠物</a>|<a href="?cmd=$phcmd" >排行</a>
<br/>
<a href="?cmd=$ztcmd">状态</a>|<a href="?cmd=$getbagcmd" >背包</a>|<a href="?cmd=$getbagjncmd" >技能</a>|<a href="?cmd=$imcmd" >好友</a>|<a href="?cmd=$duihuancmd" >兑换</a>
<br/>---------------------------<br/>
<a href="http://snsky.com" >天空社区</a>|<a href="index.php" >返回登录</a><br/>
HTML;
echo $nowhtml;
?>