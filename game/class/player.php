...
function addchongwu($sid,$dblj){
    $cw = array('勾陈','螣蛇','应龙','黄龙','朱雀','玄武','白虎','青龙','幽荧','烛照');//宠物名字
    $uphp = mt_rand(8,25);
    $upgj = mt_rand(2,5);
    $upfy = mt_rand(3,8);
    $cwpz = mt_rand(0,500);
    ...
    $cwfy = 4;
    $sjs = mt_rand(0,7);
    $sql = "insert into playerchongwu(cwname,cwlv,cwhp,cwmaxhp,cwgj,cwfy,uphp,upgj,upfy,cwpz,sid) VALUES ('$cw[$sjs]','$cwlv','$cwhp','$cwmaxhp','$cwgj','$cwfy','$uphp','$upgj','$upfy','$cwpz','$sid')";
    $cxjg = $dblj->exec($sql);
}
